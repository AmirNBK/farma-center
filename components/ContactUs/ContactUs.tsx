    ...
    return (
        ...
        >
            ...
            <div className='text-white text-center md:text-right px-5'>
                <h3 className='mb-6 text-2xl sm:text-3xl md:text-4xl'> با ما برای کسب و کار خود در ارتباط باشید </h3>
                <h4 className='text-sm sm:text-base md:text-lg'> با ما در ارتباط باشید تا از بهترین مشاوره ها بهره مند شوید </h4>
            </div>
            <div>
